...
public class DatabaseSeeder {
    ...
    public void seed() {
        try {
            ...
            if (quiz2 == null) {
                quizDAO.addQuiz(new Quiz("Photosynthesis", "Biology", "Online", "Medium", "Year 11", "Australia", bobID));
            ...
            if (quiz3 == null) {
                quizDAO.addQuiz(new Quiz("World War II", "History", "Online", "Easy", "Year 10", "Australia", aliceID));
