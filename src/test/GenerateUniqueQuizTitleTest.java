...
public class GenerateUniqueQuizTitleTest {
    ...
    private static final String quizTopic = "Math";
    ...
    void testUniqueQuizTitle_WithOneDuplicate() {
        mockQuizDAO.saveQuiz(new Quiz(quizName, quizTopic, quizMode, difficulty, yearLevel, country, creatorID)); // Existing Quiz by User ID 1
    ...
    void testUniqueQuizTitle_WithMultipleDuplicates() {
        mockQuizDAO.saveQuiz(new Quiz(quizName, quizTopic, quizMode, difficulty, yearLevel, country, creatorID));
        //Assume first duplicate already went through the unique title method
        mockQuizDAO.saveQuiz(new Quiz("Math Quiz1", quizTopic, quizMode, difficulty, yearLevel, country, creatorID)); // Two existing duplicates
    ...
    void testUniqueQuizTitle_DifferentUser() {
        mockQuizDAO.saveQuiz(new Quiz(quizName, quizTopic, quizMode, difficulty, yearLevel, country, 2)); // Different User (ID 2)
